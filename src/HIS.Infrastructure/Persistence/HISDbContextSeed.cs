...
public static class HISDbContextSeed
{
    public static async Task SeedAsync(HISDbContext context)
    {
    ...
    private static async Task SeedLookupsAsync(HISDbContext context)
    {
    ...
    private static async Task SeedRolesAsync(HISDbContext context)
    {
        var roles = new[]
        {
            new Role
