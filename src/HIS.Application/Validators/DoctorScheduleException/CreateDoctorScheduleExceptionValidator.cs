...
{
    public sealed class CreateDoctorScheduleExceptionValidator:AbstractValidator<CreateDoctorScheduleExceptionDto>
    {
        public CreateDoctorScheduleExceptionValidator()
        {
